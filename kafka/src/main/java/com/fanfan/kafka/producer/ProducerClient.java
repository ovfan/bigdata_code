...
public class ProducerClient {
    public static void main(String[] args) {
        ...
        // 指定自定义的分区器
        // properties.put(ProducerConfig.PARTITIONER_CLASS_CONFIG,"com.fanfan.kafka.producer.MyPartitioner");
        ...
        // 3. 调用send方法，进行消息的发送
        for (int i = 0; i < 10; i++) {
            kafkaProducer.send(new ProducerRecord<String, String>("first", "hello kk"), new Callback() {
